...
$fecha1 = date('Y-m-d');
$nomb = 'Concentrado Encuesta4 '.$fecha1;
...
FROM encuesta4sismo A, numeros_sismo B 
...
if($cuantos_registros==0){
	...
	$objPHPExcel->getActiveSheet()->setCellValue('A1', 'Reporte General "Reclasificación de la vivienda" '.$fecha1);
	$nomb .='.xlsx';
