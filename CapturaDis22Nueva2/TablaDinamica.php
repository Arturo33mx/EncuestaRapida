...
<table class="table table-bordered table-hover">
    <thead>
        <tr class="bg-info text-white">
            <th></th>
            <th>11.2-1 -¿Ha oído hablar de: ?</th>
            <th>11.2-2 - ¿De qué partido político es?</th>
            <th>11.2-3 - ¿Ud. Votaría por él para DIPUTADO LOCAL?</th>
            <th>11.2-4 - Y, ¿Qué opinión tiene de él / ella?</th>
        </tr>
    </thead>
    <tbody>
 ...
 order by Clave";
        ...
        <tr>
            <td>
                <strong id="divRadPreg11-2<?php echo $mivalor['Identificador'];?>"><?php echo $mivalor['Identificador'].") ". utf8_encode($mivalor['Descripcion']); ?></strong>
            </td>
            <td>
                <select class="form-control" name="cmbPreg11-2-1[]" onchange="CorroboraTabla2(<?php echo $mivalor['Identificador'];?>,1)" id="cmbPreg11-2-1<?php echo $mivalor['Identificador']?>">
            ...
            <td>
                <select class="form-control" name="cmbPreg11-2-2[]" id="cmbPreg11-2-2<?php echo $mivalor['Identificador']?>" disabled>
                    <option value="0">Selec.</option>
            ...
            <td>
                <select class="form-control" name="cmbPreg11-2-3[]" id="cmbPreg11-2-3<?php echo $mivalor['Identificador']?>" disabled>
                    <option value="0">Selec.</option>
                    <option value="1">Si</option>
            ...
            <td>
                <select class="form-control" name="cmbPreg11-2-4[]" id="cmbPreg11-2-4<?php echo $mivalor['Identificador']?>" disabled>
                    <option value="0">Selec.</option>
...
<script>
     function CorroboraTabla2(id,opc){
        if (opc==1){
            if($('#cmbPreg11-2-1'+id).val()==1 || $('#cmbPreg11-2-1'+id).val()==2){
                $('#cmbPreg11-2-2'+id).removeAttr("disabled");
                $('#cmbPreg11-2-3'+id).removeAttr("disabled");
                $('#cmbPreg11-2-4'+id).removeAttr("disabled");
            }
            else{
