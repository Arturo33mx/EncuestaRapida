...
$consulta="select COLUMN_NAME from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'captura_lafragua';"; 
                ...
                if($total!=0){
                    ...
                    if(!empty($Result)){
                        ...
                        foreach ($Result as $mivalor){
                            ...
                            $Total = $mivalor['Total'];
                            $objPHPExcel->getActiveSheet()->setCellValue($Abc[$IdxAbc].$indx,($Total));
                            $indx++;
                            $indice++;
                        }
                    }
