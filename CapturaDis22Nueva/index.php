	...
	<div class="content-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12" id="divRadPreg10">
                                        <h4>10.- Le voy a leer una lista de personalidades del Distrito:  </h4>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12" id="divRadPreg11">
                                        <h4>11.- ¿Quién de los nombres que le acabo de leer le gustaría que fuera  Diputado Local por este Distrito?</h4>
                                    </div>
                                    <div class="col-md-6">
                                        <select class="form-control" id="cmbPreg11">
                                        ...
                                        <?php
                                            foreach ($array as $i => $value) {
                                                $pos = strpos($array[$i], ")");
                                                echo "<option value='".($i+3)."'>".($i+3).substr($array[$i],$pos)."</option>";
                                            }
                                            ?>
                                            <option value="3">7) Otro</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12" id="divRadPreg12">
                                        <h4>12.- Si hoy fueran las elecciones y los unicos candidatos fueran tarjeta 5 ¿Por cual de estas opciones votaria para DIPUTADO LOCAL?</h4>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12" id="divRadPreg14">
                                        <h4>14.- Independientemente de por quién va a votar, ¿quién cree que ganará las elecciones para Diputado Local en este Distrito?</h4>
                                    </div>
                                    <div class="col-md-12">
		...
		<script>
			...
			$("#btnGuardar").click(function(){
				...
				$("#divRadPreg10-11").css('border', 'none');
				$("#divRadPreg10-12").css('border', 'none');
				$("#divRadPreg10-13").css('border', 'none');
				$("#divRadPreg10-14").css('border', 'none');
                ...
                if($("#cmbMunicipio").val()==0){
                    ...
                    $("select[name='cmbPreg10-2-1[]']").each(function(index){
                        $("#divRadPreg10-2"+(index+1)).css('border', 'none');
                    });
                    $("select[name='cmbPreg10-2-1[]']").each(function(index){
                        if($(this).val()==0){
                            $('#divRadPreg10-2'+(index+1)).css({"border-bottom" : "3px solid #f00d0d"});
                            campo='#divRadPreg10-2'+(index+1);
                            err=true;
                             //alert(campo);
                        }
                        else{
                            if($(this).val()==1 || $(this).val()==2){
                                if($('#cmbPreg10-2-2'+(index+1)).val()==0){
                                    $('#divRadPreg10-2'+(index+1)).css({"border-bottom" : "3px solid #f00d0d"});
                                    campo='#divRadPreg10-2'+(index+1);
                                    err=true;
                                }
                                if($('#cmbPreg10-2-3'+(index+1)).val()==0){
                                    $('#divRadPreg10-2'+(index+1)).css({"border-bottom" : "3px solid #f00d0d"});
                                    campo='#divRadPreg10-2'+(index+1);
                                    err=true;
                                }
                                if($('#cmbPreg10-2-4'+(index+1)).val()==0){
                                    $('#divRadPreg10-2'+(index+1)).css({"border-bottom" : "3px solid #f00d0d"});
                                    campo='#divRadPreg10-2'+(index+1);
                                    err=true;
                                }
                ...
                id = 1;
                while (id<=4){
                    if($('#cmbPreg1011'+id).val()==0){
                        $('#divRadPreg10-1'+id).css({"border-bottom" : "3px solid #f00d0d"});
                        campo='#divRadPreg10-1'+id;
                        err=true;
                    }
                    else{
                        if($('#cmbPreg1011'+id).val()==1 || $('#cmbPreg1011'+id).val()==2){
                            if($('#cmbPreg1012'+id).val()==0){
                                $('#divRadPreg10-1'+id).css({"border-bottom" : "3px solid #f00d0d"});
                                campo='#divRadPreg10-1'+id;
                                err=true;
                            }
                            if($('#cmbPreg1013'+id).val()==0){
                                $('#divRadPreg10-1'+id).css({"border-bottom" : "3px solid #f00d0d"});
                                campo='#divRadPreg10-1'+id;
                                err=true;
                            }
                            if($('#cmbPreg1014'+id).val()==0){
                                $('#divRadPreg10-1'+id).css({"border-bottom" : "3px solid #f00d0d"});
                                campo='#divRadPreg10-1'+id;
                                err=true;
                            }
				...
				if(err){
                    ...
                    var Array2="";
                    $("select[name='cmbPreg10-2-2[]']").each(function(index){
                        Array2=Array2+","+$(this).val();
                    });
                    var Array3="";
                    $("select[name='cmbPreg10-2-3[]']").each(function(index){
                        Array3=Array3+","+$(this).val();
                    });
                    var Array4="";
                    $("select[name='cmbPreg10-2-4[]']").each(function(index){
					...
					$.post("GuardaLlamada.php",{
                        ...
                        res1011: $("#cmbPreg10111").val(),
                        res1021: $("#cmbPreg10121").val(),
                        res1031: $("#cmbPreg10131").val(),
                        res1041: $("#cmbPreg10141").val(),
                        res1012: $("#cmbPreg10112").val(),
                        res1022: $("#cmbPreg10122").val(),
                        res1032: $("#cmbPreg10132").val(),
                        res1042: $("#cmbPreg10142").val(),
                        res1013: $("#cmbPreg10113").val(),
                        res1023: $("#cmbPreg10123").val(),
                        res1033: $("#cmbPreg10133").val(),
                        res1043: $("#cmbPreg10143").val(),
                        res1014: $("#cmbPreg10114").val(),
                        res1024: $("#cmbPreg10124").val(),
                        res1034: $("#cmbPreg10134").val(),
                        res1044: $("#cmbPreg10144").val(),
