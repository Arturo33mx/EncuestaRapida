...
while($index<=15){
    $sql="SELECT 
    (select count(`Res12-".$index."-1`)FROM encuesta_distrito22 where `Res12-".$index."-1`=1)uno,
    (select count(`Res12-".$index."-1`)FROM encuesta_distrito22 where `Res12-".$index."-1`=2)dos,
    (select count(`Res12-".$index."-1`)FROM encuesta_distrito22 where `Res12-".$index."-1`=3)tres,
    (select count(`Res12-".$index."-1`)FROM encuesta_distrito22 where `Res12-".$index."-1`=4)cuatro;"; 
    $Result=$bd->consulta($sql);
    //echo $sql;
    $cuantos_registros= $bd->num_rows($Result);
    if($cuantos_registros!=0){
